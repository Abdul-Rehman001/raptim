...
export function BoardColumn({ id, title, jobs }: BoardColumnProps) {
  return (
    <div className="flex flex-col h-full min-w-70 w-[320px] bg-bg-surface rounded-lg border border-border-subtle shrink-0 shadow-sm p-4">
      <div className="flex items-center justify-between mb-4 px-1">
        <h3 className="text-sm font-semibold text-text-primary uppercase tracking-widest flex items-center gap-2">
